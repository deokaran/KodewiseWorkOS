...
export default async function TLLogPage() {
  await requireRole("TEAM_LEADER");

  // Fetch all audit logs across both Football Counter and Kodewise
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-1">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900 font-heading">Work Activity Log</h2>
        <p className="text-sm text-gray-500">
          View full audit history and activity logs for all work items across the studio.
        </p>
      </div>
              ...
              return (
                <TableRow key={log.id} className="hover:bg-gray-50">
                  ...
                  <TableCell className="font-medium text-indigo-600">
                    <Link href={`/tl/work/${log.workItemId}`} className="hover:underline">
