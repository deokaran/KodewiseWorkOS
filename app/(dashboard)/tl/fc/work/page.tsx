...
export default async function TlFcWorkPage() {
  ...
  const filteredWorkItems = workItems.filter((w: any) => w.primaryBrandTag?.name === "Football Counter");

  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-1">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900 font-heading">Football Counter Work Items</h2>
        <p className="text-sm text-gray-500">
          Manage all Football Counter active deliverables.
        </p>
      </div>
